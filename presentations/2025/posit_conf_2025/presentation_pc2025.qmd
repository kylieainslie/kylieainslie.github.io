...
::: {.fragment}
![](figures/project_file_hellscape.png){height=70%}
:::
...
:::{.column width="50%"}
::: {.fragment index="1"}
![](figures/hellscape_dir_screenshot.png){width="90%" style="max-height: 80vh; object-fit: contain;"}
:::
:::
...
:::{.column width="40%"}
::: {.fragment index="3"}
![](figures/vacamole_dir_screenshot.png){width="90%" style="max-height: 80vh; object-fit: contain;"}
:::
:::
:::::
...
![](figures/nl_covid_confirmed_cases.png){width="100%" style="max-height: 500px; object-fit: contain;"}

::: {.fragment}
![](figures/nl_covid_confirmed_cases_decreasing.png){width="98%" style="max-height: 500px; object-fit: contain;"}
:::

::: {.fragment}
![](figures/nl_covid_confirmed_cases_vaccination.png){width="100%" style="max-height: 500px; object-fit: contain;"}
:::

::: {.fragment}
![](figures/nl_covid_confirmed_cases_measures.png){width="98%" style="max-height: 500px; object-fit: contain;"}
:::
:::
...
::: incremental
-   :arrow_right: **Easy Handovers** → New team members instantly understand structure
-   :mag: **Full Reproducibility** → Anyone can verify and replicate your analysis
-   :hammer_and_wrench: **Extensible Work** → Others build new features on your foundation
-   :people_holding_hands: **External Collaboration** → Domain experts can contribute directly
:::
